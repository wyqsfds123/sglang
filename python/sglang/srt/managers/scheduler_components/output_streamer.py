            ...
            self.send_to_detokenizer.send_output(
                BatchTokenIDOutput(
                    ...
                    input_token_logprobs_val=(
                        acc.input_token_logprobs_val if return_logprob else None
                    ),
                    input_token_logprobs_idx=(
                        acc.input_token_logprobs_idx if return_logprob else None
                    ),
                    output_token_logprobs_val=(
                        acc.output_token_logprobs_val if return_logprob else None
                    ),
                    output_token_logprobs_idx=(
                        acc.output_token_logprobs_idx if return_logprob else None
                    ),
                    input_top_logprobs_val=(
                        acc.input_top_logprobs_val if return_logprob else None
                    ),
                    input_top_logprobs_idx=(
                        acc.input_top_logprobs_idx if return_logprob else None
                    ),
                    output_top_logprobs_val=(
                        acc.output_top_logprobs_val if return_logprob else None
                    ),
                    output_top_logprobs_idx=(
                        acc.output_top_logprobs_idx if return_logprob else None
                    ),
                    input_token_ids_logprobs_val=(
                        acc.input_token_ids_logprobs_val if return_logprob else None
                    ),
                    input_token_ids_logprobs_idx=(
                        acc.input_token_ids_logprobs_idx if return_logprob else None
                    ),
                    output_token_ids_logprobs_val=(
                        acc.output_token_ids_logprobs_val if return_logprob else None
                    ),
                    output_token_ids_logprobs_idx=(
                        acc.output_token_ids_logprobs_idx if return_logprob else None
                    ),
