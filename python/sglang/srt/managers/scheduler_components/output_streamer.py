...
class _GenerationStreamAccumulator:
    ...
    # Logprob arrays (12): only appended when ``return_logprob`` is True;
    # ``to_payload`` returns them as ``None`` otherwise to match IPC contract.
    input_token_logprobs_val: list = field(default_factory=list)
    input_token_logprobs_idx: list = field(default_factory=list)
    output_token_logprobs_val: list = field(default_factory=list)
    output_token_logprobs_idx: list = field(default_factory=list)
    input_top_logprobs_val: list = field(default_factory=list)
    input_top_logprobs_idx: list = field(default_factory=list)
    output_top_logprobs_val: list = field(default_factory=list)
    output_top_logprobs_idx: list = field(default_factory=list)
    input_token_ids_logprobs_val: list = field(default_factory=list)
    input_token_ids_logprobs_idx: list = field(default_factory=list)
    output_token_ids_logprobs_val: list = field(default_factory=list)
    output_token_ids_logprobs_idx: list = field(default_factory=list)
    ...
    def to_payload(
        ...
        return BatchTokenIDOutput(
            ...
            input_token_logprobs_val=(
                self.input_token_logprobs_val if self.return_logprob else None
            ),
            input_token_logprobs_idx=(
                self.input_token_logprobs_idx if self.return_logprob else None
            ),
            output_token_logprobs_val=(
                self.output_token_logprobs_val if self.return_logprob else None
            ),
            output_token_logprobs_idx=(
                self.output_token_logprobs_idx if self.return_logprob else None
            ),
            input_top_logprobs_val=(
                self.input_top_logprobs_val if self.return_logprob else None
            ),
            input_top_logprobs_idx=(
                self.input_top_logprobs_idx if self.return_logprob else None
            ),
            output_top_logprobs_val=(
                self.output_top_logprobs_val if self.return_logprob else None
            ),
            output_top_logprobs_idx=(
                self.output_top_logprobs_idx if self.return_logprob else None
            ),
            input_token_ids_logprobs_val=(
                self.input_token_ids_logprobs_val if self.return_logprob else None
            ),
            input_token_ids_logprobs_idx=(
                self.input_token_ids_logprobs_idx if self.return_logprob else None
            ),
            output_token_ids_logprobs_val=(
                self.output_token_ids_logprobs_val if self.return_logprob else None
            ),
            output_token_ids_logprobs_idx=(
                self.output_token_ids_logprobs_idx if self.return_logprob else None
            ),
