...
class LoraController:
            ...
            async with self.lora_update_lock:
                ...
                if self.server_args.max_loaded_loras is not None:
                    while (
                        ...
                        unload_result = (
                            await LoraController._unload_lora_adapter_locked(
    ...
    async def unload_lora_adapter(
        ...
        try:
            ...
            async with self.lora_update_lock:
                return await LoraController._unload_lora_adapter_locked(self, obj)
        except ValueError as e:
    ...
    async def _validate_and_resolve_lora(
        ...
        await LoraController._resolve_lora_path(self, obj)
    ...
    async def _resolve_lora_path(
        ...
        for lora_path in unregistered_loras:
            ...
            load_result = await LoraController.load_lora_adapter(
                self,
                LoadLoRAAdapterReqInput(
